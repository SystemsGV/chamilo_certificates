...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter&amp;family=Work+Sans:wght@700&amp;display=swap"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7836/Header-bg.png'); background-repeat: no-repeat; background-size: cover; background-color: #000000; border-radius: 0; color: #000000; width: 700px; margin: 0 auto;"
                                        width="700">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 193.333px;"><a
                                                                            href="https://institutodozer.com/"
                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="icons_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="vertical-align: middle; color: #000000; font-family: 'Noto Serif', Georgia, serif; font-size: 24px; letter-spacing: 0px; padding-bottom: 10px; padding-top: 10px; text-align: center;">
                                                    ...
                                                    <table class="heading_block block-2" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #000000; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 41px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 49.199999999999996px;">
                                                                    <span
                                                                        class="tinyMce-placeholder">Felicitaciones</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table class="heading_block block-3" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h2
                                                                    style="margin: 0; color: #201f42; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 24px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 28.799999999999997px;">
                                                                    {{ $student->name_student }}</h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="paragraph_block block-5" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <br>
                                                                <div
                                                                    style="color:#1b1b2b;direction:ltr;font-family:Inter, sans-serif;font-size:16px;font-weight:600;letter-spacing:0px;line-height:180%;text-align:center;mso-line-height-alt:28.8px;">
                                                                    <p style="margin: 0;">Por encargo de Walter Stwen
                                                                        Gomez, Gerente del Centro de Capacitación
                                                                        Profesional, queremos felicitarlo en nombre del
                                                                        Instituto DOZER. Por haber obtenido de manera
                                                                        satisfactoria el certificado. Este logro no
                                                                        habría sido posible sin su interés y dedicación
                                                                        constante a lo largo de estos meses.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="heading_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #ffffff; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 40px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 48px;">
                                                                    <span class="tinyMce-placeholder">Necesitas
                                                                        Ayuda?<br></span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-right:10px;">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;"><a
                                                                            href="mailto:administracion@dozer.edu.pe"
                                                                            target="_blank"
                                                                            style="text-decoration: underline; color: #ffffff;"
                                                                            rel="noopener"><u>Contactanos</u> -&gt;</a>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; background-color: #201f42; border-radius: 0; color: #000000; width: 700px; margin: 0 auto;"
                                        width="700">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="33.333333333333336%"
                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 154.667px;"><a
