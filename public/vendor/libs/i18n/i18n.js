                        ...
                        if (
                            ...
                            if (
                                ...
                                const t = this.options.returnedObjectHandler
                                    ? this.options.returnedObjectHandler(h, p, {
                                          ...e,
                                          ns: s,
                                      })
                ...
                class E {
                    ...
                    needsPlural(t) {
                        ...
                        return this.shouldUseIntlApi()
                            ? n &&
                                  n.resolvedOptions().pluralCategories.length >
                                      1
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (!r || "cimode" !== r.toLowerCase()) {
                                        var s = [],
                                            a = function (t) {
                                                o.toResolveHierarchy(t).forEach(
                                                    function (t) {
                                                        s.indexOf(t) < 0 &&
                                                            s.push(t);
                                                    }
                            ...
                            if ("undefined" != typeof window) {
                                ...
                                if (n instanceof Array)
                                    if (
                                        ...
                                        if (
                                            "string" !=
                                            typeof n[t.lookupFromPathIndex]
                                        )
                                            return;
